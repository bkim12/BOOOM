...
In this study, $\lambda_1$ and  $\lambda_2$ take integer values **from 0 to 9**. To **keep the downstream scripts** (Pareto plot and optimal-solution analyses) aligned with the saved outputs, 

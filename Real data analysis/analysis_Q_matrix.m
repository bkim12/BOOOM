...
var_names = readcell("X_names.csv");
...
filename = fullfile('./Results','var_ranks_QN.csv');
writecell(var_ranks, filename);

filename = fullfile('./Results','var_l2_vals_QN.csv');
writematrix(var_l2_vals, filename);

filename = fullfile('./Results','non_zeros_indicator_QN.csv');
